...
//)
//
//// ZsetOperation string类型操作的定义
//type ZaddOperation struct {
//	ctx context.Context
//}
//
//// NewStringOperation 新建string操作实例 隐藏redis本身
//func NewZaddOperation() *ZaddOperation {
//	return &ZaddOperation{ctx: context.Background()}
//}
//
//
//func (z *ZaddOperation)Get(){
//	cmd.Redis().z
//}
//
//func (z *ZaddOperation)Range(){}
//
//
//func (z *ZaddOperation)Add(key string,v ...[]interface{}){
//
//}
////
////// Set 设置string类型
